package com.jackal.photoeditor.black.bounder;
...
//    }
	...
	private class AsyncBitmapBuilder extends AsyncTask<Uri, Void, Void> {

		@Override
		protected void onPostExecute(Void result) {
			Toast.makeText(getApplicationContext(), R.string.toastDone, Toast.LENGTH_LONG).show();
			Button button = (Button)findViewById(R.id.startButton);
		...
		protected Void doInBackground(Uri... params) {
	        ...
	        o.inPurgeable = true;
	        o.outHeight = boundary;
	        o.outWidth = boundary;

	        try { 
	    		BitmapFactory.Options.class.getField("inNativeAlloc").setBoolean(o, true);
			} catch (Exception e) { e.printStackTrace(); }

	        Bitmap srcBitmap = BitmapFactory.decodeFile(selectedImagePath, o);

	        if (srcBitmap == null) Log.d(TAG, "NULL");
